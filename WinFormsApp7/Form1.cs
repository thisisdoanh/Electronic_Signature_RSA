...
namespace WinFormsApp7
{
    public partial class Form1 : Form
    {
        ...
        private void btnKy_Click(object sender, EventArgs e)
        {
            ...
            {
                hashMD5Text = hashMD5Word(this.txtBanRo);
            }
            else
            {
                hashMD5Text = hashMD5(this.txtBanRo.Text);
            }
        ...
        public void OpenDocxFile(string fileName, RichTextBox richTextBox)
        {
            Microsoft.Office.Interop.Word.Application word = new Microsoft.Office.Interop.Word.Application();
            ...
            try
            {
                ...
                // Paste vào richtextbox
                richTextBox.Paste();


                richTextBox.Font = new System.Drawing.Font("Segoe UI", 9, FontStyle.Regular);
